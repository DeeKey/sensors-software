...
const char INTL_ENABLE_BATTERY_MONITOR[] PROGMEM = "Активирoвать монитор батареи";
const char INTL_BATTERY_CAPACITY[] PROGMEM = "Заряд батареи";
const char INTL_BATTERY_U_MIN[] PROGMEM = "Напряжение разряда (mV):";
const char INTL_BATTERY_U_MAX[] PROGMEM = "Напряжение заряда (mV):";
const char INTL_ADC_DIVIDER_U_MAX[] PROGMEM = "Макс. напряжение на АЦП (mV):";
